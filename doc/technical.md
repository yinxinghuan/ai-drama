...
- 平台元信息：meta.title=AI 短剧导演；cover_url=/poster.png；category=tool；uuid=1d28ce76-54b5-4fb7-b099-9ecfc029847d
...
- `src/Drama/Drama.less`
- `src/Drama/types.ts`
- `src/Drama/Drama.tsx`
- `src/Drama/utils/aigramPublicApi.ts`
- `src/Drama/utils/imageApi.ts`
- `src/Drama/utils/works.ts`
- `src/Drama/utils/presets.ts`
