...
AI 短剧导演 是一个 `tool` 类型的移动端小游戏：AI 短剧导演 — 选角色、写分镜、一键生成你的短剧

## 2. Visual Design

- 整体布局：页面占用 100vw x 100vh，主体验居中，HUD 与操作区覆盖在游戏层上方，移动端以单手操作为优先。
- 背景与配色：主要颜色使用 rgba(191, 173, 136, 0.3)、rgba(240, 236, 224, 0.09)、#bfad88、#dedad0、#ccc8bc、#8a8680、rgba(222, 218, 208, 0.24)、#302f2c；高亮元素用于可点击目标、得分、结果或稀有状态。
- 字体：使用 var(--font)、var(--font-serif)、var(--font-serif-cn)、var(--font-serif)">G</div>，按钮与状态文字保持 12-24 px 的可读范围。
...
- avocado_soldier_ref.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- lemon_ref2.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- ume_ref_4.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- ume_ref_5.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- watermelon_bear_ref2.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- family_ref.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- ume_ref_side.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- pearl_angel_ref.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- ume.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- pearl_angel.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
